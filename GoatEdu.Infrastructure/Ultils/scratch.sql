...
ALTER TABLE "theory_flashcard_content" ADD FOREIGN KEY ("theory_id") REFERENCES "theories" ("theory_id");
...
ALTER TABLE "user_subject" ADD FOREIGN KEY ("subject_id") REFERENCES "subjects" ("subject_id");

ALTER TABLE "user_subject" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("user_id");
...
ALTER TABLE "wallets" ADD FOREIGN KEY ("transaction_id") REFERENCES "transactions" ("transaction_id");

ALTER TABLE "flashcard_contents" ADD FOREIGN KEY ("flashcard_id") REFERENCES "flashcards" ("flashcard_id");

ALTER TABLE "flashcards" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("user_id");
...
ALTER TABLE "discussions" ADD FOREIGN KEY ("subject_id") REFERENCES "subjects" ("subject_id");

ALTER TABLE "answers" ADD FOREIGN KEY ("question_id") REFERENCES "discussions" ("discussion_id");

ALTER TABLE "notes" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("user_id");

ALTER TABLE "flashcards" ADD FOREIGN KEY ("subject_id") REFERENCES "subjects" ("subject_id");

ALTER TABLE "lessons" ADD FOREIGN KEY ("chapter_id") REFERENCES "chapters" ("chapter_id");

ALTER TABLE "quizzes" ADD FOREIGN KEY ("lesson_id") REFERENCES "lessons" ("lesson_id");

ALTER TABLE "theories" ADD FOREIGN KEY ("lesson_id") REFERENCES "lessons" ("lesson_id");
